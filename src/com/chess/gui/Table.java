...
public final class Table extends Observable {
    ...
    private Color lightTileColor = Color.decode("#CC6502");
    private Color darkTileColor = Color.decode("#ffcc99");
    ...
    private class BoardPanel extends JPanel {
        ...
        BoardPanel() {
            ...
            setBorder(BorderFactory.createLineBorder(Color.decode("#A52A2A"), 5));
