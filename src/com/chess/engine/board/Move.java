...
//      result = prime * result + this.movedPiece.getPiecePosition();
    ...
    static abstract class CastleMove extends Move {
        ...
        public Board execute() {
            ...
            builder.setPiece(this.movedPiece.movePiece(this)); //moving the king
            //todo look into the first move on normal pieces
            builder.setPiece(new Rook(this.castleRookDestination, this.castleRook.getPieceAlliance())); //setting the new rook at the castling position
            builder.setMoveMaker(this.board.currentPlayer().getOpponent().getAlliance()); //giving turn to the opponent
            return builder.build();
        }
    }
